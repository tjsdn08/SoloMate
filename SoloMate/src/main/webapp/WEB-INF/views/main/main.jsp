...
<div class="summary-dashboard">
    ...
    <div class="dashboard-section">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="bookmark-card empty-state">북마크한 레시피가 없습니다.</div>
            </c:otherwise>
        </c:choose>
    </div>
    ...
    <div class="dashboard-section">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="bookmark-card empty-state">북마크한 꿀팁이 없습니다.</div>
            </c:otherwise>
        </c:choose>
    </div>
    ...
    <div class="dashboard-section">
        <div class="section-header">
            유통기한 임박 식품
            <span class="sub-text">D-7 이하</span>
        </div>
        <c:choose>
    ...
    <div class="dashboard-section">
        <div class="section-header">
            장보기 예정
            <span class="sub-text">최근 등록순</span>
        </div>
        <c:choose>
            ...
            <c:otherwise>
                <div class="empty-state">구매 예정인 항목이 없습니다.</div>
            </c:otherwise>
        </c:choose>
    </div>
...
<div class="quick-access-container">
    <a href="/recipes/list.do" class="quick-btn">
        <div class="icon">🍳</div><span>레시피 찾기</span>
    </a>
    <a href="/board/list.do" class="quick-btn">
        <div class="icon">💡</div><span>꿀팁 게시판</span>
    </a>
    <a href="/shopping/list.do" class="quick-btn">
